"use strict";
/* build-hook-start *//*00001*/try { require('/Users/stefanhorning/.vscode/extensions/wallabyjs.console-ninja-1.0.395/out/buildHook/index.js').default({tool: 'angular', checkSum: '20fd79b3af9fe2050facddV1MZCkwEWwMKX1YGBgVVUQcBUwFf', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/stefanhorning/.vscode/extensions/wallabyjs.console-ninja-1.0.395/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20fd79b3af9fe2050facddV1MZCkwEWwMKX1YGBgVVUQcBUwFf', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

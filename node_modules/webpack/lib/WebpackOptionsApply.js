...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/Users/stefanhorning/.vscode/extensions/wallabyjs.console-ninja-1.0.358/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20e7e4f0a3f54e6e00defaUBlcBEgDWwMFBVYABARWCV1SBFNU', mode: 'build'}); } catch(cjsError) { try { import('file:///Users/stefanhorning/.vscode/extensions/wallabyjs.console-ninja-1.0.358/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20e7e4f0a3f54e6e00defaUBlcBEgDWwMFBVYABARWCV1SBFNU', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
